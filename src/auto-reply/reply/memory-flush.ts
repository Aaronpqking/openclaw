...
const MEMORY_FLUSH_READ_ONLY_HINT =
  "Treat workspace bootstrap/reference files such as AGENTS.md, SOUL.md, TOOLS.md, USER.md, OPERATIONS.md, APPROVALS.md, CHANNELS.md, PROJECTS.md, and MEMORY.md as read-only during this flush; never overwrite, replace, or edit them.";
